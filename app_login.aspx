<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="app_login.aspx.cs" Inherits="B_ERP_CMS.app_login" %>
                                    ...
                                    <div class="col-md-8 pl-md-0">
                                        <div class="auth-form-wrapper px-4 py-5">
                                          <a href="#" class="noble-ui-logo d-block mb-2">B<span>EMS</span></a>
                                            <h5 class="text-muted font-weight-normal mb-4">Welcome! Log in to your Application account.</h5>
                                            <div class="forms-sample">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Username <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEmail" ErrorMessage="[Requid]" ForeColor="Red"></asp:RequiredFieldValidator></label>
