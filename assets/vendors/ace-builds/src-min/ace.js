(function () {
            ...
            v = function (e, t) {
                ...
                var D = !1,
                    P = function (e, r) {
                        ...
                        return (
                            ...
                            !r && f == a.length && !o && !u && !l
                                ? ""
                                : ((y = !0), (a && !o && !u && !f && !l) || S ? t.onTextInput(a) : t.onTextInput(a, { extendLeft: o, extendRight: u, restoreStart: f, restoreEnd: l }), (y = !1), (T = e), (N = i), (C = s), a)
                        );
                    },
                    H = function (e) {
                        if (g) return U();
                ...
                r.addListener(n, "compositionstart", R),
                    ...
                    (this.moveToMouse = function (e, o) {
                        b || (b = n.style.cssText), (n.style.cssText = (o ? "z-index:100000;" : "") + (i.isIE ? "opacity:0.1;" : "") + "text-indent: -" + (N + C) * t.renderer.characterWidth * 0.5 + "px;");
            ...
            function y() {
                (l += 60),
                    (f = setInterval(function () {
                        l-- <= 0 && (clearInterval(f), (f = null)), Math.abs(p) < 0.01 && (p = 0), Math.abs(d) < 0.01 && (d = 0), l < 20 && (p = 0.9 * p), l < 20 && (d = 0.9 * d), t.renderer.scrollBy(10 * p, 10 * d);
                    }, 10));
            }
            var n = "scroll",
                i,
    ...
    define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/app_config"], function (e, t, n) {
        ...
        var u = (function () {
            ...
            a = { packaged: !1, workerPath: null, modePath: null, themePath: null, basePath: "", suffix: ".js", $moduleUrls: {}, loadWorkerFromBlob: !0, sharedPopups: !1 };
        (t.get = function (e) {
        ...
        var f = function () {
            !a.basePath &&
                ...
                (console.error("Unable to infer path to ace from script src,", "use ace.config.set('basePath', 'path') to enable dynamic loading of modes and themes", "or with webpack use ace/webpack-resolver"), (f = function () { }));
        };
        ...
        (d.$uid = 0),
            function () {
                ...
                r.implement(this, u),
                    ...
                    (this.$defaultUndoManager = { undo: function () { }, redo: function () { }, reset: function () { }, add: function () { }, addSelection: function () { }, startNewGroup: function () { }, addSession: function () { } }),
                    ...
                    (this.$getUndoSelection = function (e, t) {
                        ...
                        for (var o = 0; o < e.length; o++) {
                            ...
                            n(u)
                                ? ((i = u.start), r.compare(i.row, i.column) == -1 && r.setStart(i), (i = u.end), r.compare(i.row, i.column) == 1 && r.setEnd(i), (s = !0))
